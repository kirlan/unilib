...
namespace Persona
{
    public partial class EditConditionStatus : Form
    {
        ...
        public EditConditionStatus(ConditionStatus pCondition, Module pModule)
        {
            InitializeComponent();
            ...
            comboBox1.Items.AddRange(pModule.m_cBoolParameters.ToArray());

            foreach (ObjectsCollection pColl in pModule.m_cCollections)
                comboBox1.Items.AddRange(pColl.m_cBoolParameters.ToArray());
