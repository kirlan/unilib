...
namespace Persona
{
    public partial class EditParameterNumeric : Form
    {
        ...
        public EditParameterNumeric(NumericParameter pParam)
        {
            ...
            textBox3.Text = m_pParam.m_sFormat;
        ...
        public EditParameterNumeric(NumericParameter pParam, string sCollection)
        {
            InitializeComponent();
        ...
        {
            NumericParameter.Range pRange = new NumericParameter.Range((float)numericUpDown2.Value);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            m_pParam.m_sFormat = textBox3.Text;
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            // Navigate to a URL.
            System.Diagnostics.Process.Start("https://msdn.microsoft.com/ru-ru/library/0c899ak8(v=vs.110).aspx");
        }
    }
}
