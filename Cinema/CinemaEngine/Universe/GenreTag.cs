...
{
    /// <summary>
    /// Категория действия. Указывает хардкорность действия в рамках различных жанров.
    /// Например, ураганная перестрелка в метро - это очень круто для экшена,
    /// но весьма слабо для хоррора
    /// </summary>
