    ...
    public class State : BorderBuilder<Province>, ITerritory
    {
        ...
        private static StateInfo[] s_aInfo = 
        {
            new StateInfo("Land", 1,
                new SettlementInfo(SettlementSize.Hamlet, "Hamlet", 5, 10, 2, new BuildingInfo("Elder's hut", "Patriarch", "Matriarch", BuildingSize.Unique)), 
                new SettlementInfo(SettlementSize.Hamlet, "Hamlet", 5, 10, 2, new BuildingInfo("Elder's hut", "Elder", "Elder", BuildingSize.Unique)), 
            ...
            new StateInfo("Tribes", 1,
                new SettlementInfo(SettlementSize.Village, "Village", 10, 20, 3, new BuildingInfo("Clans hall", "Patriarch", "Matriarch", BuildingSize.Unique)), 
                new SettlementInfo(SettlementSize.Village, "Village", 10, 20, 3, new BuildingInfo("Village hall", "Elder", "Elder", BuildingSize.Unique)), 
            ...
            new StateInfo("Federation", 2,
                new SettlementInfo(SettlementSize.Capital, "City", 40, 80, 16, new BuildingInfo("Statehouse", "Chairman", "Chairman", BuildingSize.Unique)), 
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 15, new BuildingInfo("Town hall", "Mayor", "Mayor", BuildingSize.Unique)), 
                "Deputy", "Deputy", false, 4, 7, false, null),
            new StateInfo("League", 3,
                new SettlementInfo(SettlementSize.Capital, "City", 40, 80, 16, new BuildingInfo("Palace", "Speaker", "Speaker", BuildingSize.Unique)), 
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 15, new BuildingInfo("Palace", "Governor", "Governor", BuildingSize.Unique)), 
            ...
            new StateInfo("Alliance", 3,
                new SettlementInfo(SettlementSize.Capital, "City", 40, 80, 16, new BuildingInfo("Palace", "Ruler", "Ruler", BuildingSize.Unique)), 
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 15, new BuildingInfo("Town hall", "Mayor", "Mayor", BuildingSize.Unique)), 
                "Minister", "Ministress", false, 5, 7, true, null),
            new StateInfo("Coalition", 3,
                new SettlementInfo(SettlementSize.Capital, "City", 40, 80, 16, new BuildingInfo("Statehouse", "Speaker", "Speaker", BuildingSize.Unique)), 
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 15, new BuildingInfo("Town hall", "Mayor", "Mayor", BuildingSize.Unique)), 
                "Minister", "Ministress", false, 5, 7, true, null),
            new StateInfo("Association", 3,
                new SettlementInfo(SettlementSize.Capital, "City", 40, 80, 16, new BuildingInfo("Statehouse", "Chairman", "Chairman", BuildingSize.Unique)), 
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 15, new BuildingInfo("Town hall", "Governor", "Governor", BuildingSize.Unique)), 
                "Senator", "Senator", false, 5, 7, true, null),
            ...
            new StateInfo("Commonwealth", 1,
                new SettlementInfo(SettlementSize.Town, "Town", 20, 40, 16, new BuildingInfo("Town hall", "Speaker", "Speaker", BuildingSize.Unique)), 
                new SettlementInfo(SettlementSize.Town, "Town", 20, 40, 15, new BuildingInfo("Town hall", "Manager", "Manager", BuildingSize.Unique)), 
                "Advisor", "Advisor", false, 7, 8, false, null),
            new StateInfo("Society", 1,
                new SettlementInfo(SettlementSize.Village, "Village", 10, 20, 16, new BuildingInfo("Village hall", "", "", BuildingSize.Unique)), 
                new SettlementInfo(SettlementSize.Village, "Village", 10, 20, 15, new BuildingInfo("Village hall", "", "", BuildingSize.Unique)), 
