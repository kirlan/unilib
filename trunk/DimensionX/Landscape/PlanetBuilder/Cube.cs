...
namespace LandscapeGeneration.PlanetBuilder
{
        ...
        where LOC : Location, new()
    {
        ...
        public Dictionary<CubeFace3D, CubeFace<LOC>> m_cFaces = new Dictionary<CubeFace3D, CubeFace<LOC>>();
        ...
        public Cube(int locationsCount, int iFaceSize, WorkingArea eArea, BeginStepDelegate BeginStep, ProgressStepDelegate ProgressStep)
        {
            var size = 1000;
            ...
            m_cFaces[CubeFace3D.Backward] = new CubeFace<LOC>(iFaceSize, pBoundingRectHR, ref locsHR, ref vertsHR, size, R, CubeFace3D.Backward, true);
            ...
            {
                m_cFaces[CubeFace3D.Bottom] = new CubeFace<LOC>(iFaceSize, pBoundingRectLR, ref locsLR, ref vertsLR, size, R, CubeFace3D.Bottom, false);
                if (ProgressStep != null)
                    ProgressStep();
                m_cFaces[CubeFace3D.Forward] = new CubeFace<LOC>(iFaceSize, pBoundingRectLR, ref locsLR, ref vertsLR, size, R, CubeFace3D.Forward, false);
                if (ProgressStep != null)
                    ProgressStep();
                m_cFaces[CubeFace3D.Left] = new CubeFace<LOC>(iFaceSize, pBoundingRectLR, ref locsLR, ref vertsLR, size, R, CubeFace3D.Left, false);
                if (ProgressStep != null)
                    ProgressStep();
                m_cFaces[CubeFace3D.Right] = new CubeFace<LOC>(iFaceSize, pBoundingRectLR, ref locsLR, ref vertsLR, size, R, CubeFace3D.Right, false);
                if (ProgressStep != null)
                    ProgressStep();
                m_cFaces[CubeFace3D.Top] = new CubeFace<LOC>(iFaceSize, pBoundingRectLR, ref locsLR, ref vertsLR, size, R, CubeFace3D.Top, false);
                if (ProgressStep != null)
                    ProgressStep();
            }
            else
            {
                m_cFaces[CubeFace3D.Left] = new CubeFace<LOC>(iFaceSize, pBoundingRectHR, ref locsHR, ref vertsHR, size, R, CubeFace3D.Left, true);
                if (ProgressStep != null)
                    ProgressStep();

                if (eArea == WorkingArea.WholeSphere)
                {
                    m_cFaces[CubeFace3D.Bottom] = new CubeFace<LOC>(iFaceSize, pBoundingRectHR, ref locsHR, ref vertsHR, size, R, CubeFace3D.Bottom, true);
                    if (ProgressStep != null)
                        ProgressStep();
                    m_cFaces[CubeFace3D.Forward] = new CubeFace<LOC>(iFaceSize, pBoundingRectHR, ref locsHR, ref vertsHR, size, R, CubeFace3D.Forward, true);
                    if (ProgressStep != null)
                        ProgressStep();
                    m_cFaces[CubeFace3D.Right] = new CubeFace<LOC>(iFaceSize, pBoundingRectHR, ref locsHR, ref vertsHR, size, R, CubeFace3D.Right, true);
                    if (ProgressStep != null)
                        ProgressStep();
                    m_cFaces[CubeFace3D.Top] = new CubeFace<LOC>(iFaceSize, pBoundingRectHR, ref locsHR, ref vertsHR, size, R, CubeFace3D.Top, true);
                    if (ProgressStep != null)
                        ProgressStep();
                }
                else
            ...
            m_cFaces[CubeFace3D.Backward].LinkNeighbours(m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Rotate90CW,
                                                        m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Rotate180,
                                                        m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Rotate90CCW,
                                                        m_cFaces[CubeFace3D.Left], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Bottom], VertexCH.Transformation.Rotate90CW,
                                                        m_cFaces[CubeFace3D.Bottom], VertexCH.Transformation.Rotate180,
                                                        m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Rotate90CCW,
                                                        m_cFaces[CubeFace3D.Right], VertexCH.Transformation.Stright);
            if (ProgressStep != null)
                ProgressStep();

            m_cFaces[CubeFace3D.Bottom].LinkNeighbours(m_cFaces[CubeFace3D.Left], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Forward], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Right], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Right], VertexCH.Transformation.Rotate90CW,
                                                        m_cFaces[CubeFace3D.Backward], VertexCH.Transformation.Rotate90CW,
                                                        m_cFaces[CubeFace3D.Backward], VertexCH.Transformation.Rotate180,
                                                        m_cFaces[CubeFace3D.Backward], VertexCH.Transformation.Rotate90CCW,
                                                        m_cFaces[CubeFace3D.Left], VertexCH.Transformation.Rotate90CCW);
            if (ProgressStep != null)
                ProgressStep();

            m_cFaces[CubeFace3D.Forward].LinkNeighbours(m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Rotate90CCW,
                                                        m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Rotate90CW,
                                                        m_cFaces[CubeFace3D.Right], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Bottom], VertexCH.Transformation.Rotate90CCW,
                                                        m_cFaces[CubeFace3D.Bottom], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Bottom], VertexCH.Transformation.Rotate90CW,
                                                        m_cFaces[CubeFace3D.Left], VertexCH.Transformation.Stright);
            if (ProgressStep != null)
                ProgressStep();

            m_cFaces[CubeFace3D.Left].LinkNeighbours(m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Rotate180,
                                                        m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Rotate90CCW,
                                                        m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Forward], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Bottom], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Bottom], VertexCH.Transformation.Rotate90CW,
                                                        m_cFaces[CubeFace3D.Bottom], VertexCH.Transformation.Rotate180,
                                                        m_cFaces[CubeFace3D.Backward], VertexCH.Transformation.Stright);
            if (ProgressStep != null)
                ProgressStep();

            m_cFaces[CubeFace3D.Right].LinkNeighbours(m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Rotate90CW,
                                                        m_cFaces[CubeFace3D.Top], VertexCH.Transformation.Rotate180,
                                                        m_cFaces[CubeFace3D.Backward], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Bottom], VertexCH.Transformation.Rotate180,
            ...
            m_cFaces[CubeFace3D.Top].LinkNeighbours(m_cFaces[CubeFace3D.Backward], VertexCH.Transformation.Rotate90CW,
                                                        m_cFaces[CubeFace3D.Backward], VertexCH.Transformation.Rotate180,
                                                        m_cFaces[CubeFace3D.Backward], VertexCH.Transformation.Rotate90CCW,
                                                        m_cFaces[CubeFace3D.Right], VertexCH.Transformation.Rotate90CCW,
                                                        m_cFaces[CubeFace3D.Right], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Forward], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Left], VertexCH.Transformation.Stright,
                                                        m_cFaces[CubeFace3D.Left], VertexCH.Transformation.Rotate90CW);
