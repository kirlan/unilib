...
namespace VixenQuest
{
    ...
    class Opponent: Person
    {
        ...
        //Значит нам нужно хотя бы 10 рангов для описаний животных, чтобы не было разрывов
        private static ValuedString[] m_aAnimalMood = 
        {
            new ValuedString("fat ", 0),
            new ValuedString("hairy ", 1),
            new ValuedString("black ", 1),
            new ValuedString("young ", 2),
            //new ValuedString("old ", 1),
            new ValuedString("wild ", 2),
            new ValuedString("amative ", 3),
            new ValuedString("horny ", 3),
            new ValuedString("lusty ", 3),
            new ValuedString("sexy ", 3),
            new ValuedString("horned ", 4),
            new ValuedString("big-eyed ", 4),
            new ValuedString("mad ", 5),
            new ValuedString("crazy ", 5),
            new ValuedString("mighty ", 5),
            //new ValuedString("sinful ", 2),
            //new ValuedString("wise ", 2),
            new ValuedString("posessed ", 6),
            new ValuedString("devious ", 6),
            new ValuedString("glorious ", 7),
            new ValuedString("infamous ", 7),
            new ValuedString("heroic ", 8),
            new ValuedString("well-known ", 8),
            new ValuedString("legendary ", 9),
            new ValuedString("sacred ", 10),
            new ValuedString("mythic ", 11),
        };

        //для людей ранг профессии 1-8, и ранг расы - до 30 с шагом 5
        private static ValuedString[] m_aMood = 
        {
            ...
            new ValuedString("well-known ", 15),
            //"topless ", 1),
            //"bottomless ", 1),
            new ValuedString("devious ", 16),
            new ValuedString("epic ", 17),
            new ValuedString("legendary ", 18),
            new ValuedString("innocent ", 19),
            new ValuedString("virgin ", 20),
        };
        ...
        private static ValuedString[] m_aProfessionM = 
        {
            ...
            new ValuedString("Prince", 15),
            new ValuedString("King", 16),
            new ValuedString("Patriarch", 16),
            new ValuedString("Warlord", 16),
            new ValuedString("Messiah", 17),
            new ValuedString("Emperor", 17),
        };
        ...
        private static ValuedString[] m_aProfessionF = 
        {
            ...
            new ValuedString("Princess", 15),
            new ValuedString("Queen", 16),
            new ValuedString("Matriarch", 16),
            new ValuedString("Messiah", 17),
            new ValuedString("Empress", 17),
        };
        ...
        public Opponent(Race pRace)
        {
            ...
            switch (pRace.m_eSapience)
            {
                case Sapience.Animal:
                    break;
                case Sapience.Human:
                    if (m_eGender == Gender.Female || m_eGender == Gender.Shemale)
                    {
                        ...
                        {
                            int part2 = Rnd.Get(m_aProfessionF.Length);
                            m_sSingleName += m_aProfessionF[part2].m_sName;
                            m_iLevel += m_aProfessionF[part2].m_iValue;
                        }
                        else
                        {
                            ...
                            {
                                int part2 = Rnd.Get(m_aProfessionM.Length);
                                m_sSingleName += m_aProfessionM[part2].m_sName;
                                m_iLevel += m_aProfessionM[part2].m_iValue;
                            }
                            if (m_sSingleName.EndsWith("s"))
                                m_sSingleName += "'";
                            else
                                m_sSingleName += "'s";

                            if (Rnd.OneChanceFrom(5))
                                m_sSingleName += " ex-girlfriend";
                            else
                                if (Rnd.OneChanceFrom(4))
                                    m_sSingleName += " girlfriend";
                                else
                                    if (Rnd.OneChanceFrom(3))
                                        m_sSingleName += " daughter";
                                    else
                                        if (Rnd.OneChanceFrom(2))
                                            m_sSingleName += " stepsister";
                                        else
                                            m_sSingleName += " sister";
                        }
                    }
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (Rnd.OneChanceFrom(5))
                                m_sSingleName += " ex-boyfriend";
                            else
                                if (Rnd.OneChanceFrom(4))
                                    m_sSingleName += " boyfriend";
                                else
                                    if (Rnd.OneChanceFrom(3))
                                        m_sSingleName += " son";
                                    else
                                        if (Rnd.OneChanceFrom(2))
                                            m_sSingleName += " stepbrother";
                                        else
                                            m_sSingleName += " brother";
                        }
                    }
                    break;
                case Sapience.God:
            ...
            m_cSkills[pRace.m_ePreferredSexType] = m_iLevel + Rnd.Get(m_iLevel);
        }
    }
}
