...
namespace MiscControls
{
    ...
    public partial class BorderLabel : Label
    {
        ...
        public BorderLabel()
        {
            ...
            this.drawPen = new Pen(new SolidBrush(Color.FromArgb(200, this.borderColor)), borderSize);
...
//                    this.drawPen.Color = value;
                    this.drawPen.Color = Color.FromArgb(200, value);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            GraphicsPath outlinePath = (GraphicsPath)this.drawPath.Clone();
            outlinePath.Widen(this.drawPen);
            e.Graphics.DrawPath(this.drawPen, outlinePath);
