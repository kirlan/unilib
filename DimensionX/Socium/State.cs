                            ...
                            else
                            {
                                ...
                                else
                                {
                                    if (Rnd.OneChanceFrom(2))
                                    {
                                        ...
                                        if (m_pSociety.m_pTitularNation.DominantPhenotype.ValueOf<BrainGenetix>().m_eIntelligence == Intelligence.Sapient)
                                            fScience *= 2;
                                        if (m_pSociety.m_pTitularNation.DominantPhenotype.ValueOf<BrainGenetix>().m_eIntelligence == Intelligence.Ingenious)
                                            fScience *= 4;
