...
namespace Socium
{
    public class StateInfo
    {
        ...
        public StateInfo(string sName, int iRank, SettlementInfo pStateCapital, SettlementInfo pProvinceCapital, bool bDinasty, int iMinGovernmentLevel, int iMaxGovernmentLevel, bool bBig, Language[] cLanguages)
        {
            m_sName = sName;
            m_iRank = iRank;
    ...
    public class State : BorderBuilder<Province>, ITerritory
    {
        ...
        private static StateInfo[] s_aInfo = 
        {
            ...
            new StateInfo("Kingdom", 1,
                ...
                true, 2, 6, false, new Language[] {Language.Dwarwen, Language.European, Language.Highlander, Language.Northman}),
            new StateInfo("Kingdom", 1,
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 14, new BuildingInfo("Castle", ProfessionInfo.KingEuro, ProfessionInfo.KingHeirEuro, BuildingSize.Unique)), 
                ...
                true, 2, 6, false, new Language[] {Language.Drow, Language.Elven, Language.European, Language.Highlander}),
            new StateInfo("Empire", 2,
                ...
                true, 2, 6, true, new Language[] {Language.Drow, Language.Elven, Language.European, Language.Dwarwen}),            
            new StateInfo("Regnum", 1,
                ...
                true, 2, 6, false, new Language[] {Language.Latin}),
            new StateInfo("Imperium", 2,
                ...
                true, 2, 6, true, new Language[] {Language.Latin}),
            new StateInfo("Shogunate", 1,
                ...
                true, 2, 6, false, new Language[] {Language.Asian}),            
            new StateInfo("Empire", 2,
                ...
                true, 2, 6, true, new Language[] {Language.Asian}),
            new StateInfo("Caliphate", 1,
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 14, new BuildingInfo("Castle", ProfessionInfo.KingArabian, ProfessionInfo.KingHeirEuro, BuildingSize.Unique)), 
                ...
                true, 2, 6, false, new Language[] {Language.Arabian}),
            new StateInfo("Sultanate", 1,
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 14, new BuildingInfo("Castle", ProfessionInfo.KingArabian2, ProfessionInfo.KingHeirEuro, BuildingSize.Unique)), 
                new SettlementInfo(SettlementSize.Town, "Town", 20, 40, 7, new BuildingInfo("Castle", ProfessionInfo.GovernorArabian2, ProfessionInfo.GovernorArabian2, BuildingSize.Unique)), 
                true, 2, 6, false, new Language[] {Language.Arabian, Language.African}),            
            new StateInfo("Empire", 2,
                ...
                new SettlementInfo(SettlementSize.Town, "Town", 20, 40, 7, new BuildingInfo("Castle", ProfessionInfo.GovernorArabian2, ProfessionInfo.GovernorArabian2, BuildingSize.Unique)), 
                true, 2, 6, true, new Language[] {Language.Arabian, Language.African}),
            new StateInfo("Khanate", 1,
                ...
                true, 2, 6, false, new Language[] {Language.Orkish, Language.Eskimoid}),
            new StateInfo("Khaganate", 2,
                ...
                true, 2, 6, true, new Language[] {Language.Orkish, Language.Eskimoid}),
            new StateInfo("Knyazdom", 1,
                ...
                true, 2, 6, false, new Language[] {Language.Slavic}),
            new StateInfo("Tsardom", 2,
                ...
                true, 2, 6, true, new Language[] {Language.Slavic}),
            new StateInfo("Basileia", 1,
                ...
                true, 2, 6, false, new Language[] {Language.Greek}),
            new StateInfo("Autokratoria", 2,
                ...
                true, 2, 6, true, new Language[] {Language.Greek}),
            new StateInfo("Raj", 1,
                ...
                true, 2, 6, false, new Language[] {Language.Hindu}),            
            new StateInfo("Empire", 2,
                ...
                true, 2, 6, true, new Language[] {Language.Hindu}),
            new StateInfo("Altepetl", 1,
                ...
                true, 2, 6, false, new Language[] {Language.Aztec}),           
            new StateInfo("Empire", 2,
                ...
                new SettlementInfo(SettlementSize.Town, "Town", 20, 40, 7, new BuildingInfo("Castle", ProfessionInfo.GovernorAztec, ProfessionInfo.GovernorAztec, BuildingSize.Unique)), 
                true, 2, 6, true, new Language[] {Language.Aztec}),
