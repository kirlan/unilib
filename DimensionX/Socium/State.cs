    ...
    public class State : BorderBuilder<Province>, ITerritory
    {
        ...
        private static StateInfo[] s_aInfo = 
        {
            ...
            new StateInfo("Regnum", 1,
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 14, 5, 7, new BuildingInfo("Castle", "Rex", "Regina", 16)), 
                new SettlementInfo(SettlementSize.Town, "Town", 20, 40, 7, 2, 5, new BuildingInfo("Castle", "Dux", "Ducissam", 9)), 
                "Princeps", "Principissa", true, 2, 8, false, new Language[] {Language.Latin}),
            new StateInfo("Imperium", 2,
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 14, 5, 7, new BuildingInfo("Castle", "Imperator", "Imperatrix", 16)), 
                new SettlementInfo(SettlementSize.Town, "Town", 20, 40, 7, 2, 5, new BuildingInfo("Castle", "Rex", "Regina", 9)), 
            ...
            new StateInfo("Empire", 2,
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 14, 5, 7, new BuildingInfo("Castle", "Padishah", "Padishahbanu", 16)), 
                new SettlementInfo(SettlementSize.Town, "Town", 20, 40, 7, 2, 5, new BuildingInfo("Castle", "Shah", "Shahbanu", 9)), 
            ...
            new StateInfo("Khanate", 1,
                ...
                new SettlementInfo(SettlementSize.Town, "Town", 20, 40, 7, 2, 5, new BuildingInfo("Castle", "Bey", "Hanım", 9)), 
            ...
            new StateInfo("Tsardom", 2,
                ...
                new SettlementInfo(SettlementSize.Town, "Town", 20, 40, 7, 2, 5, new BuildingInfo("Castle", "Knyaz", "Kniagina", 9)), 
                "Tsarevich", "Tsarevna", true, 2, 8, true, new Language[] {Language.Slavic}),
            new StateInfo("Basileia", 1,
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 14, 5, 7, new BuildingInfo("Castle", "Basileus", "Basilissa", 16)), 
                new SettlementInfo(SettlementSize.Town, "Town", 20, 40, 7, 2, 5, new BuildingInfo("Castle", "Hypatos", "Hypatissa", 9)), 
                "Prinkipas", "Prinkipissa", true, 2, 8, false, new Language[] {Language.Greek}),
            new StateInfo("Autokratoria", 2,
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 14, 5, 7, new BuildingInfo("Castle", "Autokrator", "Autokrateira", 16)), 
                new SettlementInfo(SettlementSize.Town, "Town", 20, 40, 7, 2, 5, new BuildingInfo("Castle", "Anthypatos", "Anthypatissa", 9)), 
            ...
            new StateInfo("Coalition", 3,
                new SettlementInfo(SettlementSize.Capital, "City", 40, 80, 16, 5, 10, new BuildingInfo("Statehouse", "Speaker", "Speaker", 17)), 
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 15, 5, 10, new BuildingInfo("Town hall", "Mayor", "Mayor", 15)), 
                "Minister", "Ministress", false, 5, 7, true, null),
            new StateInfo("Association", 3,
                new SettlementInfo(SettlementSize.Capital, "City", 40, 80, 16, 5, 10, new BuildingInfo("Statehouse", "Chairman", "Chairman", 17)), 
                new SettlementInfo(SettlementSize.City, "City", 40, 80, 15, 5, 10, new BuildingInfo("Town hall", "Governor", "Governor", 15)), 
