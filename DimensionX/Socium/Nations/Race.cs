...
namespace Socium.Nations
{
    public class Race
    {
        ...
        public Race(string sName, int iRank, Language pLanguage, Fenotype<LandTypeInfoX> pFenotypeM, Fenotype<LandTypeInfoX> pFenotypeF, MentalityTemplate pCulture)
        { 
            m_sName = sName;
            m_iRank = iRank;
            ...
            m_pFenotypeM = (Fenotype<LandTypeInfoX>)pFenotypeM.MutateRace();
            if (m_pFenotypeM.m_pHairs.m_cHairColors.Count == 0 &&
                (m_pFenotypeM.m_pHairs.m_eHairs != HairsAmount.None ||
                 m_pFenotypeM.m_pHairs.m_eBeard != HairsAmount.None))
                throw new Exception();

            if (pFenotypeF == null)
                pFenotypeF = pFenotypeM;

            m_pFenotypeF = (Fenotype<LandTypeInfoX>)pFenotypeF.MutateRace();
            if (m_pFenotypeF.m_pHairs.m_cHairColors.Count == 0 &&
                (m_pFenotypeF.m_pHairs.m_eHairs != HairsAmount.None ||
                 m_pFenotypeF.m_pHairs.m_eBeard != HairsAmount.None))
                throw new Exception();
