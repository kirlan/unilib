...
{
    internal class Latin:Language
    {
        private readonly Confluxer m_pName;

        private readonly Confluxer m_pFamily;

        private readonly Confluxer m_pCountry;

        private readonly Confluxer m_pTown;

        private readonly Confluxer m_pVillage;
