...
{
    internal class Slavic: Language
    {
        private readonly Confluxer m_pNations;

        private readonly Confluxer m_pCountries;

        private readonly Confluxer m_pTowns;

        private readonly Confluxer m_pVillages;
