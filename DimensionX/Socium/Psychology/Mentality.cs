        ...
        private static Dictionary<Trait, TraitPhase[]> TraitPhases
        {
            get
            {
                return s_cTraitPhases ?? (s_cTraitPhases = new Dictionary<Trait, TraitPhase[]>
                    {
                        [Trait.Agression] = new[]                        {   new TraitPhase(Trait.Agression, 0.0f, 0.33f, "(+3) completely pacifistic"),
                        ...
                        [Trait.Selfishness] = new[]                        {   new TraitPhase(Trait.Selfishness, 0.0f, 0.33f, "(+3) completely selfless"),
                        ...
                        [Trait.Simplicity] = new[]                        {   new TraitPhase(Trait.Simplicity, 0.0f, 0.33f, "(+3) creativity as a supreme value"),
                        ...
                        [Trait.Fanaticism] = new[]                        {   new TraitPhase(Trait.Fanaticism, 0.0f, 0.33f, "(+3) fully tolerant"),
                        ...
                        [Trait.Piety] = new[]                        {   new TraitPhase(Trait.Piety, 0.0f, 0.33f, "(+3) atheism"),
                        ...
                        [Trait.Treachery] = new[]                        {   new TraitPhase(Trait.Treachery, 0.0f, 0.33f, "(+3) righteous"),
