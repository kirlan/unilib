...
namespace TestCubePlanet
{
    public class CubeFace
    {
        ...
        public CubeFace(int iResolution, Rect pBounds2D, ref VertexCH[] locations, ref CellCH[] vertices, float fSize, int iR, Cube.Face3D eFace, bool bHighRes)
        {
            ...
            for (int x = 0; x < Resolution; x++)
                for (int y = 0; y < Resolution; y++ )
                    m_cChunk[x, y] = new Chunk(ref locations, pBounds2D, ref vertices, fSize * x, fSize * y, fSize * Resolution, iR, eFace, bHighRes);
        }
