...
namespace RB.Socium.Languages
{
    class Highlander:Language
    {
        ...
        { 
            string sFamily = "maclay macbiset macboyd macboyl macbroud macbrown macburnet macdonald macruar macraig macford macdaron macdewar macdouglas macdunbar macerskin macfenton macfraser mackened maclanont maclockhart maclogan macalister macaulay macbain macdonald macdonel macfly mackay mackenzie mackinon macintosh maclaren maclean macleon macmilan macnab macneil macrae macgil macmalcolm macmaxton macmaxwel macmofat macmunro macnapier macnesbit";
