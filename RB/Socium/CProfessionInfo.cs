...
namespace RB.Socium
{
    public class ProfessionInfo
    {
        ...
        /// </summary>
        public Dictionary<CPerson.Skill, SkillLevel> m_cSkills = new Dictionary<CPerson.Skill, SkillLevel>();
        ...
        {
            m_cSkills[CPerson.Skill.Body] = eBody;
            m_cSkills[CPerson.Skill.Mind] = eMind;
            m_cSkills[CPerson.Skill.Charm] = eCharm;
        }
