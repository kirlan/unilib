...
namespace RB.Socium
{
    public class CEstate
    {
        ...
        public List<CStratum> m_cStratums = new List<CStratum>();
        ...
        public Customs GetCustoms(CPerson._Gender eGender)
        {
            if (m_pCustoms.m_eGenderPriority == Customs.GenderPriority.Genders_equality ||
                (m_pCustoms.m_eGenderPriority == Customs.GenderPriority.Patriarchy && eGender == CPerson._Gender.Male) ||
                (m_pCustoms.m_eGenderPriority == Customs.GenderPriority.Matriarchy && eGender == CPerson._Gender.Female))
                return m_pCustoms;
            else
        ...
        public CEstate(CSociety pSociety, Position ePosition)
        {
            m_ePosition = ePosition;
        ...
        {
            foreach (CStratum pStratum in m_cStratums)
                pStratum.FixGenderPriority(this);
        }

        private CPerson.Skill m_eMostRespectedSkill;
        ...
        private CPerson.Skill m_eLeastRespectedSkill;
